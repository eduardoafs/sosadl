...
Require Import tests.testChoose4.
      ...
      * { apply type_SystemDecl_gate with "gate1"; mysplit.
          ...
          - apply type_SystemDecl_None.
            ...
            apply type_Valuing_None with (RangeType (Some (IntegerValue (Some 0)))
                                                    (Some (IntegerValue (Some 0)))); mysplit.
            + apply type_expression_IntegerValue.
            + apply type_Choose.
              apply Forall_cons.
              * { apply type_Valuing_None with (RangeType (Some (IntegerValue (Some 1)))
                                                          (Some (IntegerValue (Some 1)))); mysplit.
                  - apply type_expression_IntegerValue.
              ...
              * { apply Forall_cons.
                  - apply type_Valuing_None with (RangeType (Some (IntegerValue (Some 2)))
                                                            (Some (IntegerValue (Some 2)))); mysplit.
                    + apply type_expression_IntegerValue.
