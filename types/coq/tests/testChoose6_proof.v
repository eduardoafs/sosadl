...
Require Import tests.testChoose6.
...
Definition type1: t_DataType := RangeType (Some (IntegerValue (Some 2)))
                                         (Some (IntegerValue (Some 3))).
    ...
    + apply (type_SystemDecl_datatype_None _ _ _ type1 _ _ _ _ _); mysplit.
      ...
      * { apply (type_SystemDecl_gate _ _ _ "gate1" _ _ _) ; mysplit.
          ...
          - apply type_SystemDecl_None.
            ...
            + { apply Forall_cons.
                apply_type_SendStatement (RangeType (Some (IntegerValue (Some 2)))
