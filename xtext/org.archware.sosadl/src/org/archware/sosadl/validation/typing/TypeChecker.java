...
public class TypeChecker extends AccumulatingValidator {
	/**
	 * List of the type variables generated during type-checking.
	 */
	 ...
	 * 
	 * <p>
	 * This method calls the solver for each of the type variables generated by the type-checker. Then it calls the associated delayed task.
	 * The former is expected to return the type that substitutes the variable. The latter typically fills in place-holders in the proof tree.
	 * 
	 * <p>
	 * When a typa variable has recorded dependencies, they are solved first. The method assumes the dependency graph is acyclic.
	 * The method implements no-more no-less a depth-first traversal of this dependency graph.
	 */
