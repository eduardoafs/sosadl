...
public class Type_expression_And implements Type_expression_node {
	...
	public Type_expression_And(Environment gamma, Expression l, DataType l__tau, Expression r, DataType r__tau,
