...
public class Type_expression_Div_neg implements Type_expression_node {
	...
	public Type_expression_Div_neg(Environment gamma, Expression l, DataType l__tau, Expression l__min, Expression l__max,
