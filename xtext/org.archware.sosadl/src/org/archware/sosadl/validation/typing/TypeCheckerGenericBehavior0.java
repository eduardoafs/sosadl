...
public abstract class TypeCheckerGenericBehavior0 extends TypeCheckerConnectionName {
    ...
    private <Body extends EObject, Statement extends EObject, Command extends EObject, Action extends EObject, Choose extends EObject, DoExpr extends EObject,
            ForEach extends EObject, IfThenElse extends EObject, Valuin extends EObject, Send extends EObject, Receive extends EObject,
    ...
    private <Body extends EObject, Statement extends EObject, Command extends EObject, Action extends EObject, Choose extends EObject, DoExpr extends EObject, ForEach extends EObject, IfThenElse extends EObject, Valuin extends EObject, Send extends EObject, Receive extends EObject, O extends ProofTerm, E extends ProofTerm, NP extends ProofTerm> Pair<Environment, Type_generic_prefixstatement<Body, Statement, Command, Action, Choose, DoExpr, ForEach, IfThenElse, Valuin, Send, Receive, O, E, NP>> genericChoose(Function<Body, EList<Statement>> getBlock, String block, Class<Action> action, Class<Choose> choose, Function<Choose, EList<Body>> getBranches, Class<DoExpr> doExpr, Class<ForEach> forEach, Class<IfThenElse> ifThenElse, Class<Valuin> valuing, Class<Send> send, Class<Receive> receive, Class<O> other, Class<E> type_expression, Class<NP> type_nonfinalbody, BiFunction<Environment, Body, NP> proveType_nonfinalbody, Environment gamma, Choose c) {
    ...
    private <Body extends EObject, Statement extends EObject, Command extends EObject, Action extends EObject, Choose extends EObject, DoExpr extends EObject, ForEach extends EObject, IfThenElse extends EObject, Valuin extends EObject, Send extends EObject, Receive extends EObject, O extends ProofTerm, E extends ProofTerm, NP extends ProofTerm> Pair<Environment, Type_generic_prefixstatement<Body, Statement, Command, Action, Choose, DoExpr, ForEach, IfThenElse, Valuin, Send, Receive, O, E, NP>> genericIfThenElse(Function<Body, EList<Statement>> getBlock, String block, Class<Action> action, Class<Choose> choose, Class<DoExpr> doExpr, Class<ForEach> forEach, Class<IfThenElse> ifThenElse, Function<IfThenElse, Expression> getCondition, EStructuralFeature conditionFeature, Function<IfThenElse, Body> getThen, EStructuralFeature thenFeature, Function<IfThenElse, Body> getElse, Class<Valuin> valuing, Class<Send> send, Class<Receive> receive, Class<O> other, Class<E> type_expression, BiFunction<Environment, Expression, Pair<E, DataType>> proveType_expression, Class<NP> type_nonfinalbody, BiFunction<Environment, Body, NP> proveType_nonfinalbody, Environment gamma, IfThenElse ite) {
    ...
    private <Body extends EObject, Statement extends EObject, Command extends EObject, Action extends EObject, Choose extends EObject, DoExpr extends EObject, ForEach extends EObject, IfThenElse extends EObject, Valuin extends EObject, Send extends EObject, Receive extends EObject, O extends ProofTerm, E extends ProofTerm, NP extends ProofTerm> Pair<Environment, Type_generic_prefixstatement<Body, Statement, Command, Action, Choose, DoExpr, ForEach, IfThenElse, Valuin, Send, Receive, O, E, NP>> genericValuing(String block, Class<Action> action, Class<Choose> choose, Class<DoExpr> doExpr, Class<ForEach> forEach, Class<IfThenElse> ifThenElse, Class<Valuin> valuing, Function<Valuin, Valuing> getValuing, EStructuralFeature valuingFeature, Class<Send> send, Class<Receive> receive, Class<O> other, Class<E> type_expression, BiFunction<Environment, Expression, Pair<E, DataType>> proveType_expression, Class<NP> type_nonfinalbody, Environment gamma, Valuin v) {
    ...
    private <Body extends EObject, Statement extends EObject, Command extends EObject, Action extends EObject, Choose extends EObject, DoExpr extends EObject, ForEach extends EObject, IfThenElse extends EObject, Valuin extends EObject, Send extends EObject, Receive extends EObject, O extends ProofTerm, E extends ProofTerm, NP extends ProofTerm> Pair<Environment, Type_generic_prefixstatement<Body, Statement, Command, Action, Choose, DoExpr, ForEach, IfThenElse, Valuin, Send, Receive, O, E, NP>> genericDoExpr(String block, Class<Action> action, Class<Choose> choose, Class<DoExpr> doExpr, Function<DoExpr, Expression> getExpression, EStructuralFeature expressionFeature, Class<ForEach> forEach, Class<IfThenElse> ifThenElse, Class<Valuin> valuing, Class<Send> send, Class<Receive> receive, Class<O> other, Class<E> type_expression, BiFunction<Environment, Expression, Pair<E, DataType>> proveType_expression, Class<NP> type_nonfinalbody, Environment gamma, DoExpr d) {
