...
public class BinaryTypeInfo<L extends DataType, R extends DataType, X extends DataType> {
	...
	public HeptaFunction<Environment, BinaryExpression, Pair<Type_expression, DataType>, Pair<Subtype, L>, Pair<Type_expression, DataType>, Pair<Subtype, R>, X, Type_expression_node> getCreateProofTerm() {
		return createProofTerm;
	}

	public HexaFunction<Environment, BinaryExpression, Pair<Type_expression, DataType>, Pair<Subtype, L>, Pair<Type_expression, DataType>, Pair<Subtype, R>, X> getCreateType() {
		return createType;
	}
