...
public class Type_nonfinalprotocol_prefix implements Type_nonfinalprotocol {
	@Mandatory
	...
	@Mandatory
	private final Type_nonfinalprotocol p2;

	public Type_nonfinalprotocol_prefix(Environment gamma, ProtocolStatement s, Environment gamma1,
			EList<ProtocolStatement> l, Type_bodyprotocol p1, Type_nonfinalprotocol p2) {
		super();
		this.gamma = gamma;
		this.s = s;
		this.gamma1 = gamma1;
	...
	public Type_nonfinalprotocol getP2() {
		return p2;
	}
