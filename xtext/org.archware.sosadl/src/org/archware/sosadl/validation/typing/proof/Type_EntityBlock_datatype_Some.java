...
@CoqType("entity (AST.EntityBlock ((AST.DataTypeDecl (Some d_name) (Some d_def) d_funs)::l) funs systems mediators architectures well typed in Gamma")
public class Type_EntityBlock_datatype_Some implements Type_entityBlock {
	...
	@CoqType("typedecl (AST.DataTypeDeck (Some d_name) (Some d_def) d_funs) well typed in Gamma")
	...
	public Type_EntityBlock_datatype_Some(Environment gamma, String d_name, DataType d_def, EList<FunctionDecl> d_funs,
