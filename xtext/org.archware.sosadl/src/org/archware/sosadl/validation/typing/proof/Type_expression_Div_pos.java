...
public class Type_expression_Div_pos implements Type_expression_node {
	...
	@Mandatory private final Expression_le pd;

	public Type_expression_Div_pos(Environment gamma, Expression l, DataType l__tau, Expression l__min, Expression l__max,
