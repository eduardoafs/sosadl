...
public class Type_generic_other<Body extends EObject, Statement extends EObject, Choose extends EObject, Done extends EObject, IfThenElse extends EObject, Repeat extends EObject, Other extends ProofTerm, P extends ProofTerm, NF extends ProofTerm>
	...
	public Type_generic_other(String block, Class<Choose> choose, Class<Done> done, Class<IfThenElse> ifThenElse,
			...
			Environment gamma, Statement s, Other p1) {
		super();
		this.block = block;
		this.choose = choose;
		this.done = done;
