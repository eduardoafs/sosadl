...
public interface ListField extends FieldDescriptor {
	 ...
	 * For instance, an implementation for {@link CoqLiteral}-annotated fields would return the contained objects, without applying the formatter function.
	 * 
	 * @param formatter the function applied to each of the contained objects.
