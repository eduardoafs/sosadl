...
public class Services {
	...
	public EList<GateDecl> allGates(Constituent c) {
		EObject e = Util.resolve((IdentExpression) c.getValue());
	...
	public Connection firstConnection(Unify u) {
		return (Connection) Util.resolve(u.getConnLeft());
	}

	public Connection secondConnection(Unify u) {
		return (Connection) Util.resolve(u.getConnRight());
	}
